...
window.onload = function() {
	...
	var url2 = "http://localhost:8080/AdminChatServlet";
			...
			.post(
					...
					function(data) {
						...
						for ( var k in data.data) {
							str += "<div class='student' id='"+data.data[k].roomid+"'><img src='/imgs/form.jpg' style='width: 30px;height: 30px;'><span>"
	...
	for (var i = 0; i < oA.length; i++) {
		...
		oA[i].onclick = function() {
			...
			var socket;
			// 建立一条与服务器的连接
			 socket = new WebSocket("ws://localhost:8080/websocket?flag="
					...
					$j("#"+roomid_chat)
							.append(
									...
									"<div class='basicInfo-left' style=float:"+align+">"+
										"<img src='/imgs/touxiang.jpg' width=50px height=50px style='border-radius:100%;padding:5px;' >"+
									"</div>"+
